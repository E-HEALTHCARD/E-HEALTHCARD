...
function Doctor(){ 
  ...
  async function findPatient(event) {
    ...
    try {
      await axios.get("http://localhost:8082/api/user/getpatient/"+pid,)
      .then((res2) => 
        {
       var patients=res2;
    ...
    return(
        ...
        <div>welcome Dr {name}</div>
        <p></p>
        <div class="container12">
	<form>
    <p>Enter PatientId to see complete profile.</p>
  <div class="form-row">
    <br/>
  ...
  <br/>
  <button type="submit" class="btn btn-primary" onClick={findPatient}>Search</button>
</form>
</div>
<div>
